...
onu <span class="variable-highlight">${puertoLogico}</span> type <span class="variable-highlight">XZ000-G3</span> sn <span class="variable-highlight">${numeroSerie}</span><br>
exit<br><br>
...
onu ${puertoLogico} type XZ000-G3 sn ${numeroSerie}\n
exit\n\n
