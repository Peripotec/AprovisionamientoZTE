...
onu <span class="variable-highlight">${d.puertoLogico}</span> type <span class="variable-highlight">ZTEG-F670</span> sn <span class="variable-highlight">${d.numeroSerie}</span><br>
exit<br><br>
...
service ppp type internet iphost 1 gemport 1 vlan ${d.vlan}<br>
...
onu ${d.puertoLogico} type ZTEG-F670 sn ${d.numeroSerie}\n
exit\n
...
service ppp type internet iphost 1 gemport 1 vlan  ${d.vlan}\n
