	...
	const config = {
		...
		aprovisionamiento: [
			...
			},
			{
				...
				comando: (d) => `onu set <span class="variable-highlight">${d.placa}</span>/<span class="variable-highlight">${d.puerto}</span>/<span class="variable-highlight">${d.puertoLogico}</span> meprof zhone-2301<br>
	`,
				copiarComando: (d) => `onu set ${d.placa}/${d.puerto}/${d.puertoLogico} meprof zhone-2301\n
	`,
			},
			{
