...
function separarVLANs(vlanInput) {
  // Logica generica si fuera necesaria, por ahora devuelve objeto vacio o lo que el motor espere si se usa
  // Como Zhone usa 'vlan' directo a menudo, quizas no se use tanto, pero el motor lo llama 'safe'.
  return { vlan1: "XXX", vlan2: "XXX", vlan3: "XXX", vlan4: "XXX" };
}